          ...
          >
            <ul className="flex flex-col sm:flex-row sm:gap-x-10 p-6 sm:p-0 sm:space-y-0 space-y-4 sm:space-y-0">
              ...
              <li className="group border-b sm:border-none py-2 sm:py-0 relative">
                ...
                >
                  <li className="py-1 lg:px-3 lg:rounded-md sm:border-b sm:py-1">
                    <Link
                      href="/about"
                      className="hover:text-[#007bff] text-gray-600 text-[17px] font-bold block lg:px-3 lg:rounded "
                      onClick={() => {
                        setIsMenuOpen(false);
                  ...
                  <li className="py-1 sm:border-b sm:py-1 lg:px-3 lg:rounded">
                    <Link
                      href="/directors"
                      className="hover:text-[#007bff] text-gray-600 text-[17px] font-bold block lg:px-3 lg:rounded "
                      onClick={() => {
              ...
              <li className="group border-b sm:border-none py-2 sm:py-0 relative">
                <button
                  className="flex items-center justify-between w-full hover:text-[#007bff] text-gray-600 text-[17px] font-bold sm:w-auto"
                  onClick={() =>
                    setShowVerticalsDropdown(!showVerticalsDropdown)
                  }
                >
                  Verticals
                  <svg
              ...
              <li className="group border-b sm:border-none py-2 sm:py-0 relative">
                <button
                  className="flex items-center justify-between w-full hover:text-[#007bff] text-gray-600 text-[17px] font-bold sm:w-auto"
                  onClick={() =>
                    setShowNewVenturesDropdown(!showNewVenturesDropdown)
                  }
                >
                  New Ventures
                  <svg
