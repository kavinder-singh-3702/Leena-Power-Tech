...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const texture = new THREE.TextureLoader().load("/assets/banner/image2.jpg");
    ...
    function animate() {
      ...
      // Adjusted multipliers to slow down motion
      offsetX = Math.sin(Date.now() * 0.0001) * 0.1;  // Slower motion
      offsetY = Math.cos(Date.now() * 0.0001) * 0.05; // Slower motion
